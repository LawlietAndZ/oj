...
type SubmitBasic struct {
	...
	Problem         *ProblemBasic `gorm:"foreignKey:identity;references:problem_identity;" json:"problem_basic"` // 关联问题基础表
	UserIdentity    string   `gorm:"column:user_identity;type:varchar(36);" json:"user_identity"`           // 用户表的唯一标识
	User            *UserBasic    `gorm:"foreignKey:identity;references:user_identity;" json:"user_basic"`       // 关联用户基础表
